...
<div class="container rounded bg-white mt-5 mb-5">
    <div class="row">
        <div class="col-md-3 border-right">
            <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" width="150px" src="{{asset('uploads/product_image/'.$admin->image)}}" width="100px" height="100px" alt="">{{$admin->gmail}}</span><span> </span></div>
        </div>
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <br> 
                <a href="{{url('edit/')}}/{{$admin->id}}" class="btn btn-outline-primary">Edit profile</a>
            </div>
        </div>
    </div>
</div>
